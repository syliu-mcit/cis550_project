      ...
      <TableContainer>
        <Table>
          ...
          <TableBody>
            ...
            {songData.map((index, i) =>
              <TableRow key={songData[i].song_id}>
                <TableCell key='#'>{songData[i].number}</TableCell>
                <TableCell key='Title'>
                  <Link onClick={() => setSelectedSongId(songData[i].song_id)}>
                    {songData[i].title}
                  </Link>
                </TableCell>
                <TableCell key='Plays'> {songData[i].plays}</TableCell>
                <TableCell key='Duration'>{formatDuration(songData[i].duration)}</TableCell>
              </TableRow>
              )} 
          </TableBody>
        </Table>
